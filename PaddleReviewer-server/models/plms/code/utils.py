...
from transformers import T5Tokenizer, RobertaTokenizer, AutoTokenizer, RobertaTokenizerFast
import nltk
...
class RefineDataset(Dataset):
    ...
    def encode_remove(self, tokenizer, text, args):
        ...
        if type(tokenizer) == AutoTokenizer or type(tokenizer) == RobertaTokenizerFast:
            return text[:-1]
